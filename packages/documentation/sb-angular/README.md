...
1.  **Create the application.**
    ...
    ```shell
    # Clone the template
    npx degit chromaui/intro-storybook-angular-template sb-angular
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `sb-angular` directory in your code editor of choice and building your first component!
