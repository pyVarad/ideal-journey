...
1.  **Create the application.**
    ...
    ```shell
    # Clone the template
    npx degit chromaui/intro-storybook-react-template storybook-react
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `storybook-react` directory in your code editor of choice and building your first component!
